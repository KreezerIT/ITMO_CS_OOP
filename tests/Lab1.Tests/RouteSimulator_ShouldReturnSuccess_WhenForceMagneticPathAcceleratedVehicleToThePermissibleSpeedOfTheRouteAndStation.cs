...
public class RouteSimulator_ShouldReturnSuccess_WhenForceMagneticPathAcceleratedVehicleToThePermissibleSpeedOfTheRouteAndStation
{
    public static IEnumerable<object[]> TestParameters()
    {
        ...
        double maxPermittedVehicleSpeedOnTheRoute = 800;
